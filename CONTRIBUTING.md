Contributing to XREP Core
==================================

The XREP Core project operates an open contributor model where anyone is
...
The following applies to code changes to the XREP Core project, and is not to be
confused with overall XREP Network Protocol consensus changes.

Whether a pull request is merged into XREP Core rests with the project merge
...
Patches that change XREP consensus rules are considerably more involved than
...
Where a patch set proposes to change the XREP consensus, it must have been
...
The project leader is the release manager for each XREP Core release.
