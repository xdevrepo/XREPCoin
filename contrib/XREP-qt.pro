...
RESOURCES += src/qt/XREP.qrc src/qt/XREP_locale.qrc

TRANSLATIONS += src/qt/locale/XREP_bg.ts \
                src/qt/locale/XREP_de.ts \
                src/qt/locale/XREP_en.ts \
                src/qt/locale/XREP_es.ts \
                src/qt/locale/XREP_fi.ts \
                src/qt/locale/XREP_fr.ts \
                src/qt/locale/XREP_it.ts \
                src/qt/locale/XREP_ja.ts \
                src/qt/locale/XREP_pl.ts \
                src/qt/locale/XREP_pt.ts \
                src/qt/locale/XREP_ru.ts \
                src/qt/locale/XREP_sk.ts \
                src/qt/locale/XREP_sv.ts \
                src/qt/locale/XREP_vi.ts \
                src/qt/locale/XREP_zh_CN.ts \
                src/qt/locale/XREP_zh_TW.ts
