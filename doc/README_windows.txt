...
Intro
-----
XREP (XREP) is a sustainable cryptocurrency modeled after 
...
high-powered mining hardware. XREP utilizes an energy efficient proof-of-stake algorithm, 
...
Setup
-----
Unpack the files into a directory and run XREP-qt.exe.

XREP Core is the original XREP client and it builds the backbone of the network.
However, it downloads and stores the entire history of XREP transactions;
