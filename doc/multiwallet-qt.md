...
In order to support loading of multiple wallets in XREP-qt, a few changes in the UI architecture will be needed.
...
Only requiring some minor changes is XREP.cpp.
...
Changes to XREP.cpp
----------------------
XREP.cpp is the entry point into XREP-qt, and as such, will require some minor modifications to provide hooks for
