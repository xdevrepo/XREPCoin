...
This mechanism has been integrated into Bitcore-Node-XREP which allows for notification to be broadcast through Insight API in one of two ways:
* WebSocket: [https://github.com/XREP/insight-api-XREP#web-socket-api](https://github.com/XREP/insight-api-XREP#web-socket-api)
* API: [https://github.com/XREP/insight-api-XREP#swifttx-transactions](https://github.com/XREP/insight-api-XREP#swifttx-transactions)
...
By default, the XREP Core daemon will launch using the following constant:

```
static const int DEFAULT_SWIFTTX_DEPTH = 5;
```

This value can be overridden by passing the following argument to the XREP Core daemon:
