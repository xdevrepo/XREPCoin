...
#   c) node1 mines 32 blocks, so now node 0 has 500000XREP, node 1 has 4250XREP, node2 has none.
#   d) node0 sends 601 XREP to node2, in two transactions (301 XREP, then 300 XREP).
