...
static bool AppInitRawTx(int argc, char* argv[])
{
    ...
    if (argc < 2 || mapArgs.count("-?") || mapArgs.count("-help")) {
        ...
        std::string strUsage = _("XREP Core XREP-tx utility version") + " " + FormatFullVersion() + "\n\n" +
                               _("Usage:") + "\n" +
                               "  XREP-tx [options] <hex-tx> [commands]  " + _("Update hex-encoded XREP transaction") + "\n" +
                               "  XREP-tx [options] -create [commands]   " + _("Create hex-encoded XREP transaction") + "\n" +
                               "\n";
...
static int CommandLineRawTx(int argc, char* argv[])
{
    ...
    try {
        ...
        if (!fCreateBlank) {
            ...
            // param: hex-encoded XREP transaction
