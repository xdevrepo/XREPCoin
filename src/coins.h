...
/** 
    ...
    ****Note - for XREP we added fCoinStake to the 2nd bit. Keep in mind when reading the following and adjust as needed.
...
public:
     ...
     * allowed.
     */
    CCoinsModifier XREPCoins(const uint256& txid);
    ...
    /** 
     * Amount of XREP coming in to a transaction
