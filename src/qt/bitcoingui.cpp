                                                                            ...
                                                                            spinnerFrame(0)
{
    ...
    QString windowTitle = tr("XREP Core") + " - ";
#ifdef ENABLE_WALLET
...
void BitcoinGUI::createActions(const NetworkStyle* networkStyle)
{
    ...
    sendCoinsAction->setStatusTip(tr("Send coins to a XREP address"));
    ...
    receiveCoinsAction->setStatusTip(tr("Request payments (generates QR codes and XREP: URIs)"));
    ...
    aboutAction = new QAction(networkStyle->getAppIcon(), tr("&About XREP Core"), this);
    aboutAction->setStatusTip(tr("Show information about XREP Core"));
    ...
    optionsAction->setStatusTip(tr("XREP configuration options for XREP"));
    ...
    signMessageAction->setStatusTip(tr("Sign messages with your XREP addresses to prove you own them"));
    verifyMessageAction = new QAction(QIcon(":/icons/transaction_0"), tr("&Verify message..."), this);
    verifyMessageAction->setStatusTip(tr("Verify messages to ensure they were signed with specified XREP addresses"));
    ...
    openAction->setStatusTip(tr("Open a XREP: URI or payment request"));
    openBlockExplorerAction = new QAction(QIcon(":/icons/explorer"), tr("&Blockchain explorer"), this);
    openBlockExplorerAction->setStatusTip(tr("Block explorer window"));

    showHelpMessageAction = new QAction(QApplication::style()->standardIcon(QStyle::SP_MessageBoxInformation), tr("&Command-line options"), this);
    showHelpMessageAction->setMenuRole(QAction::NoRole);
    showHelpMessageAction->setStatusTip(tr("Show the XREP Core help message to get a list with possible XREP command-line options"));
...
void BitcoinGUI::createTrayIcon(const NetworkStyle* networkStyle)
{
    ...
    QString toolTip = tr("XREP Core client") + " " + networkStyle->getTitleAddText();
...
void BitcoinGUI::setNumConnections(int count)
{
    ...
    labelConnectionsIcon->setToolTip(tr("%n active connection(s) to XREP network", "", count));
}
...
{
    QString strTitle = tr("XREP Core"); // default title
