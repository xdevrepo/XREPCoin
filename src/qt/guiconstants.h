...
/* XREP GUI -- Size of icons in status bar */
...
#define QAPP_ORG_NAME "XREP"
#define QAPP_ORG_DOMAIN "XREP.com"
#define QAPP_APP_NAME_DEFAULT "XREP-Qt"
#define QAPP_APP_NAME_TESTNET "XREP-Qt-testnet"
