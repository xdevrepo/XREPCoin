...
static const CRPCCommand vRPCCommands[] =
    {
        ...
        /* XREP features */
        {"XREP", "masternode", &masternode, true, true, false},
        {"XREP", "listmasternodes", &listmasternodes, true, true, false},
        {"XREP", "getmasternodecount", &getmasternodecount, true, true, false},
        {"XREP", "masternodeconnect", &masternodeconnect, true, true, false},
        {"XREP", "masternodecurrent", &masternodecurrent, true, true, false},
        {"XREP", "masternodedebug", &masternodedebug, true, true, false},
        {"XREP", "startmasternode", &startmasternode, true, true, false},
        {"XREP", "createmasternodekey", &createmasternodekey, true, true, false},
        {"XREP", "getmasternodeoutputs", &getmasternodeoutputs, true, true, false},
        {"XREP", "listmasternodeconf", &listmasternodeconf, true, true, false},
        {"XREP", "getmasternodestatus", &getmasternodestatus, true, true, false},
        {"XREP", "getmasternodewinners", &getmasternodewinners, true, true, false},
        {"XREP", "getmasternodescores", &getmasternodescores, true, true, false},
        {"XREP", "mnbudget", &mnbudget, true, true, false},
        {"XREP", "preparebudget", &preparebudget, true, true, false},
        {"XREP", "submitbudget", &submitbudget, true, true, false},
        {"XREP", "mnbudgetvote", &mnbudgetvote, true, true, false},
        {"XREP", "getbudgetvotes", &getbudgetvotes, true, true, false},
        {"XREP", "getnextsuperblock", &getnextsuperblock, true, true, false},
        {"XREP", "getbudgetprojection", &getbudgetprojection, true, true, false},
        {"XREP", "getbudgetinfo", &getbudgetinfo, true, true, false},
        {"XREP", "mnbudgetrawvote", &mnbudgetrawvote, true, true, false},
        {"XREP", "mnfinalbudget", &mnfinalbudget, true, true, false},
        {"XREP", "checkbudgets", &checkbudgets, true, true, false},
        {"XREP", "mnsync", &mnsync, true, true, false},
        {"XREP", "spork", &spork, true, true, false},
#ifdef ENABLE_WALLET
...
{
    return "> XREP-cli " + methodname + " " + args + "\n";
}
...
std::string HelpExampleRpc(string methodname, string args)
{
    return "> curl --user myusername --data-binary '{\"jsonrpc\": \"1.0\", \"id\":\"curltest\", "
           "\"method\": \"" +
           methodname + "\", \"params\": [" + args + "] }' -H 'content-type: text/plain;' http://127.0.0.1:39816/\n";
}
