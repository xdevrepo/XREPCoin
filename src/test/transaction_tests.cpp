...
SetupDummyInputs(CBasicKeyStore& keystoreRet, CCoinsViewCache& coinsRet)
{
    ...
    coinsRet.XREPCoins(dummyTransactions[0].GetHash())->FromTx(dummyTransactions[0], 0);
    ...
    coinsRet.XREPCoins(dummyTransactions[1].GetHash())->FromTx(dummyTransactions[1], 0);
